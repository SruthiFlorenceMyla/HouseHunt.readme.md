...
const AllProperties = () => {
   ...
   const getAllProperty = async () => {
      try {
         const response = await axios.get('http://localhost:5000/api/owner/getownerproperties', {
   ...
   //          formData.append('propertyImage',image);
   //       }
   //       const res = await axios.put(`http://localhost:5000/api/owner/updateproperty/${propertyId}`, formData, {
   //          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` }
   //       })
   //       if (res.data.success) {
  ...
  try {
    ...
    const res = await axios.put(`
      http://localhost:5000/api/owner/updateproperty/${propertyId}`,
      formData,
      {
        headers: {
                                 ...
                                 <Form onSubmit={(e)=> {e.preventDefault();
                                    ...
                                    <Row className="mb-3">
                                       <Form.Group as={Col} md="6">
                                          ...
                                          {property.propertyImage?.path ? (
                                             <img src={`http://localhost:5000${property.propertyImage?.path}`}
                                             alt="current property" style={{width:"100%",height:"auto"}}/>
